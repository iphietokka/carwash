...
class AppointmentController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.'.$title.'.index',compact('title','data','washing_prices','vehicle_companies'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.'.$title.'.create',compact('title','users', 'vehicle_companies', 'vehicle_modals', 'vehicle_types', 'washing_plans', 'status', 'appointments', 'washing_prices'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.'.$title.'.edit', compact('title','users', 'vehicle_companies', 'vehicle_modals', 'vehicle_types', 'washing_plans', 'status', 'data', 'washing_prices'));
    }
