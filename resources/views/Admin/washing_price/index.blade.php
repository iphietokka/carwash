        ...
        <div class="box-body">
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tr><?php $a=1; ?>
              ...
              <td class="text-center">{{ Helper::getDetail('vehicle_types', $dt->vehicle_type_id,'type','id')  }}</td>
              <td class="text-center">{{ Helper::getDetail('washing_plans', $dt->washing_plan_id,'name','id')  }}</td>
              <td class="text-center">${{number_format($dt->price)}}</td>
              <td class="text-center">{{$dt->duration}} </td>
