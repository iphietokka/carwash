...
<form method="POST" action="{{url('admin/contact/edit')}}" enctype="multipart/form-data">
{{ csrf_field() }} 
...
<div class="form-group-sm">
    ...
    <div class="col-sm-9">
        ...
        <input type="text" class="form-control" placeholder="Name" name="c_name" value="{{$data->c_name}}">
    </div>
...
<div class="form-group-sm">
    ...
    <div class="col-sm-9">
        <input type="text" class="form-control" placeholder="Website" name="website" value="{{$data->website}}">
    </div>
</div>
