        ...
        <div class="box-body">
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tr>
              ...
              <td align="center">
                <img src="<?php echo e($dt->image!='' && File::exists('images/testimonials/'.$dt->image)?'/images/testimonials/'.$dt->image:'/images/default.jpg'); ?>"
                width="80px" height="70px"/>
              </td>
              <td class="text-center"><?php echo e($dt->name); ?></td>
              <td class="text-center"><?php echo e($dt->post); ?></td>
            <td class="text-center"><?php echo e($dt->detail); ?></td>
...
<?php /* /Applications/XAMPP/xamppfiles/htdocs/carwash/resources/views/admin/testimonial/index.blade.php */ ?>