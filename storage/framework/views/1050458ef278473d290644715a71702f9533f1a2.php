...
<form method="POST" action="<?php echo e(url('admin/contact/store')); ?>" enctype="multipart/form-data">
...
<?php /* /Applications/XAMPP/xamppfiles/htdocs/carwash/resources/views/admin/contact/create.blade.php */ ?>