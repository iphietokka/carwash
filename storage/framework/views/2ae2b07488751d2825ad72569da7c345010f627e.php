...
<form method="POST" action="<?php echo e(url('admin/about_us/store')); ?>" enctype="multipart/form-data">
...
<div class="form-group-sm">
 ...
 <div class="form-group-sm">
    ...
    <div class="col-sm-9">
        <input type="text" class="form-control iconpicker-custom" placeholder="Icon" name="icon">
    </div>
</div>
...
<?php /* /Applications/XAMPP/xamppfiles/htdocs/carwash/resources/views/admin/about_us/create.blade.php */ ?>