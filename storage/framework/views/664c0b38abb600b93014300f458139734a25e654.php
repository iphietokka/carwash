...
<form method="POST" action="<?php echo e(url('admin/opening_hour/store')); ?>" enctype="multipart/form-data">
...
<?php /* /Applications/XAMPP/xamppfiles/htdocs/carwash/resources/views/admin/opening_hour/create.blade.php */ ?>