...
<form method="POST" action="<?php echo e(url('admin/client/store')); ?>" enctype="multipart/form-data">
...
<?php /* /Applications/XAMPP/xamppfiles/htdocs/carwash/resources/views/Admin/client/create.blade.php */ ?>