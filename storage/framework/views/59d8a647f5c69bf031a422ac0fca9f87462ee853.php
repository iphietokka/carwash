      ...
      <div class="box">
        <div class="box-header">
          ...
          <div class="pull-right">
            <a href="about_us/create" class="btn btn-default"> <i class="fa  fa-plus-square"></i> Add User</a>
          </div>
...
<?php /* /Applications/XAMPP/xamppfiles/htdocs/carwash/resources/views/admin/about_us/index.blade.php */ ?>