<?php /* /Applications/XAMPP/xamppfiles/htdocs/carwash/resources/views/admin/washing_plan/edit.blade.php */ ?>
...
<form method="POST" action="<?php echo e(url('admin/washing_plan/edit')); ?>" enctype="multipart/form-data">
