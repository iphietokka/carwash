...
<form method="POST" action="<?php echo e(url('admin/about_us/edit')); ?>" enctype="multipart/form-data">
...
<?php /* /Applications/XAMPP/xamppfiles/htdocs/carwash/resources/views/admin/about_us/edit.blade.php */ ?>