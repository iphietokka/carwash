...
<!-- AdminLTE Skins. Choose a skin from the css/skins
   ...
   <link rel="stylesheet" href="<?php echo e(asset('backend/plugins/timepicker/bootstrap-timepicker.min.css')); ?>">
     <link rel="stylesheet" href="<?php echo e(asset('css/fontawesome-iconpicker.css')); ?>">
      <link rel="stylesheet" href="<?php echo e(asset('css/icon-font.css')); ?>">
            ...
            <nav class="navbar navbar-static-top">
                ...
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
                         <li>
            <a href="<?php echo e(url('/')); ?>" target="_blank"><i class="fa fa-eye" aria-hidden="true"></i> Visit Site</a>
          </li>
                        <!-- User Account: style can be found in dropdown.less -->
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="<?php echo e(asset('images/users')); ?>/<?php echo e(auth::user()->photo); ?>" class="user-image" alt="User Image">
                                <span class="hidden-xs"><?php echo e(auth::user()->username); ?></span>
                            </a>
                            <ul class="dropdown-menu">
                                <!-- User image -->
                                <li class="user-header">
                                    <img src="<?php echo e(asset('images/users')); ?>/<?php echo e(Auth::user()->photo); ?>" class="img-circle" alt="User Image">

                                    <p>
                                        <b><?php echo e(auth::user()->name); ?></b>
                                        <small>Member since <?php echo e(auth::user()->created_at->format('m/d/Y')); ?></small>
                                    </p>
                                </li>
                                <!-- Menu Footer-->
            ...
            <section class="sidebar">
                ...
                <div class="user-panel">
                    <div class="pull-left image">
                        <img src="<?php echo e(asset('images/users')); ?>/<?php echo e(auth::user()->photo); ?>" class="img-rounded" alt="User Image">
                    </div>
...
<!-- jQuery UI 1.11.4 -->
<script src="<?php echo e(asset('backend/dist/jquery-ui.min.js')); ?>"></script>
...
<!-- Morris.js charts -->
<script src="<?php echo e(asset('backend/dist/raphael-min.js')); ?>"></script>
<!-- Sparkline -->
...
<!-- daterangepicker -->
<script src="<?php echo e(asset('backend/dist/moment.min.js')); ?>"></script>
...
<?php /* /Applications/XAMPP/xamppfiles/htdocs/carwash/resources/views/admin/layouts/app.blade.php */ ?>