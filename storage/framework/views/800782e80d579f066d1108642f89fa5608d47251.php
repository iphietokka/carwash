    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header">
          <h3 class="box-title">All Payment Mode</h3>
          <div class="pull-right">
            <a href="payment_mode/create" class="btn btn-default"> <i class="fa  fa-plus-square"></i> Add</a>
          </div>
        ...
        <div class="box-body">
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tr><?php $a=1; ?>
              ...
              <td class="text-center"><?php echo e($dt->mode); ?></td>
...
<?php /* /Applications/XAMPP/xamppfiles/htdocs/carwash/resources/views/admin/payment_mode/index.blade.php */ ?>