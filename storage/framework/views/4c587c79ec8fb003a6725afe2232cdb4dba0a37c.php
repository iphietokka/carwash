...
<form method="POST" action="<?php echo e(url('user/profile/edit')); ?>" enctype="multipart/form-data">
...
<?php /* /Applications/XAMPP/xamppfiles/htdocs/carwash/resources/views/user/profile/edit.blade.php */ ?>