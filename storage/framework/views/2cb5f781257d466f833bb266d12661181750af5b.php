      ...
      <div class="box">
        ...
        <div class="box-body">
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody><?php $a=1;?>
            <?php $__currentLoopData = $blogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              <td class="text-center"><?php echo e($a++); ?></td>
            
              <td class="text-center"><?php echo e($dt->users->name); ?></td>
              <td class="text-center"><?php echo e($dt->title); ?></td>
              <td class="text-center"> <?php echo e($dt->date->format('Y-m-d')); ?></td>
              <td class="text-center" width="45%"><?php echo e($dt->details); ?>
...
<?php /* /Applications/XAMPP/xamppfiles/htdocs/carwash/resources/views/admin/blog/index.blade.php */ ?>