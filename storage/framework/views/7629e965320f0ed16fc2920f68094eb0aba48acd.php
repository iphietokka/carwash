        ...
        <div class="box-body">
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tr>
              ...
              <td align="center">
                <img src="<?php echo e($dt->icon!='' && File::exists('images/services/'.$dt->icon)?'/images/services/'.$dt->icon:'/images/default.jpg'); ?>"
                width="80px" height="70px"/>
              </td>
              <td class="text-center"><?php echo e($dt->name); ?></td>
              <td class="text-center"><?php echo e($dt->description); ?></td>
...
<?php /* /Applications/XAMPP/xamppfiles/htdocs/carwash/resources/views/admin/service/index.blade.php */ ?>