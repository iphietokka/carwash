...
<form method="POST" action="<?php echo e(url('admin/appointment/edit')); ?>" enctype="multipart/form-data">
    ...
    <div class="col-sm-9">
      <input type="hidden" name="id" value="<?php echo e($data->id); ?>">
        <select class="form-control" name="user_id" style="width: 100%;">
        	  ...
        	  <option value="<?php echo e($data->user_id); ?>"><?php echo e(Helper::getDetail('users', $data->user_id,'name','id')); ?></option>
...
<div class="form-group-sm">
    ...
    <div class="col-sm-9">
         <select class="form-control" name="status_id" style="width: 100%;">
        	 <option value="<?php echo e($data->status_id); ?>"><?php echo e(Helper::getDetail('statuses', $data->status_id,'status','id')); ?></option>
...
<div class="form-group-sm">
    ...
    <div class="col-sm-9">
       <input type="text" class="form-control" name="appx_hour" value="<?php echo e($data->appx_hour); ?>">
    </div>
</div>
<div class="form-group-sm">
    <label for="inputPassword3" class="col-sm-3 control-label">Remark</label>
    <div class="col-sm-9">
       <textarea class="form-control" name="remark" rows="5"><?php echo e($data->remark); ?></textarea> 
    </div>
</div>
</div>
...
<?php /* /Applications/XAMPP/xamppfiles/htdocs/carwash/resources/views/admin/appointment/edit.blade.php */ ?>