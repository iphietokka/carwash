<?php /* /Applications/XAMPP/xamppfiles/htdocs/carwash/resources/views/admin/status/create.blade.php */ ?>
...
<form method="POST" action="<?php echo e(url('admin/status/store')); ?>" enctype="multipart/form-data">
