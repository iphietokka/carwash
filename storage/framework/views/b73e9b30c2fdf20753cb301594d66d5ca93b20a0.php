        ...
        <div class="box-body">
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tr><?php $a=1; ?>
              ...
              <td class="text-center"><?php echo e($dt->vehicle_modal); ?></td>
              <td class="text-center"><?php echo e(Helper::getDetail('vehicle_companies', $dt->vehicle_company_id,'vehicle_company','id')); ?></td>
...
<?php /* /Applications/XAMPP/xamppfiles/htdocs/carwash/resources/views/admin/vehicle_model/index.blade.php */ ?>