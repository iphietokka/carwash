<?php /* /Applications/XAMPP/xamppfiles/htdocs/carwash/resources/views/admin/washing_price/edit.blade.php */ ?>
...
<form method="POST" action="<?php echo e(url('admin/washing_price/edit')); ?>" enctype="multipart/form-data">
...
<div class="form-group-sm">
    ...
    <div class="col-sm-9">
        ...
        <select class="form-control" name="vehicle_type_id" style="width: 100%;">
        	 <option value="<?php echo e($data->vehicle_type_id); ?>" selected=""><?php echo e(Helper::getDetail('vehicle_types', $data->vehicle_type_id,'type','id')); ?></option>
...
<div class="form-group-sm">
    ...
    <div class="col-sm-9">
        <select class="form-control" name="washing_plan_id" style="width: 100%;">
        	 <option value="<?php echo e($data->washing_plan_id); ?>" selected=""><?php echo e(Helper::getDetail('washing_plans', $data->washing_plan_id,'name','id')); ?></option>
...
<div class="form-group-sm">
    ...
    <div class="col-sm-9">
         <input type="text" class="form-control" name="price" value="<?php echo e($data->price); ?>"></input>
    </div>
</div>
<div class="form-group-sm">
    <label for="inputPassword3" class="col-sm-3 control-label">Duration</label>
    <div class="col-sm-9">
         <input type="text" class="form-control" name="duration" value="<?php echo e($data->duration); ?>"></input>
    </div>
</div>
