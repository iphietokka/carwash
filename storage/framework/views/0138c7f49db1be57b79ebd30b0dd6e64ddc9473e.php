      ...
      <div class="box">
        <div class="box-header">
          ...
          <div class="pull-right">
            <a href="status/create" class="btn btn-default"> <i class="fa  fa-plus-square"></i> Add</a>
          </div>
        ...
        <div class="box-body">
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tr><?php $a=1; ?>
              ...
              <td class="text-center"><?php echo e($dt->status); ?></td>
...
<?php /* /Applications/XAMPP/xamppfiles/htdocs/carwash/resources/views/admin/status/index.blade.php */ ?>