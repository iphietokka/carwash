...
<form method="POST" action="<?php echo e(url('admin/company_social/store')); ?>" enctype="multipart/form-data">
...
<?php /* /Applications/XAMPP/xamppfiles/htdocs/carwash/resources/views/admin/company_social/create.blade.php */ ?>